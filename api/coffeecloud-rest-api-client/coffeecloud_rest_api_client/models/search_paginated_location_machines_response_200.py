...
T = TypeVar("T", bound="SearchPaginatedLocationMachinesResponse200")


@attr.s(auto_attribs=True)
class SearchPaginatedLocationMachinesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        search_paginated_location_machines_response_200 = cls(
            page=page,
            amount_of_pages=amount_of_pages,
            items=items,
        )

        search_paginated_location_machines_response_200.additional_properties = d
        return search_paginated_location_machines_response_200
