...
T = TypeVar("T", bound="GetPaginatedLocationMachinesResponse200")


@attr.s(auto_attribs=True)
class GetPaginatedLocationMachinesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_paginated_location_machines_response_200 = cls(
            page=page,
            amount_of_pages=amount_of_pages,
            items=items,
        )

        get_paginated_location_machines_response_200.additional_properties = d
        return get_paginated_location_machines_response_200
